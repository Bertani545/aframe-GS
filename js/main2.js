...
/*
    ...
    J = mat3(0.5*w*n/r/cam.z, 0., -0.5*w*n/r/(cam.z*cam.z)*cam.x,
            ...
            0., 0., 0.
                ...
                //material.uniforms.viewport.value = new THREE.Vector2(540, 720)

                //material.uniforms.focal.value = new THREE.Vector2(cameraParams.fx, cameraParams.fy);
    ...
    this.sceneEl.addEventListener('loaded', () => {
      ...
      if (markerCamera) {
        ...
        if (this.camera) {
            ...
            //sceneEl.renderer.setSize(540, 720);
            
            this.sceneEl.canvas.width = 540; // Get acutal source dimentions <----------------------------------------------------------------
            this.sceneEl.canvas.height = 720;
...
*/
        ...
        this.fx = projMat.elements[0] * 540 / 2
        this.fy = projMat.elements[5] * 720 / 2
        ...
        splatMesh.material.uniforms.viewport.value = new THREE.Vector2(540, 720) // See how to obtain the "Actual source dimentionsw" <-------------------------------
